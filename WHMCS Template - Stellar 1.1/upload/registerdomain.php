...
$ca->setPageTitle($whmcs->get_lang('registerdomaintitle'));

$ca->addToBreadCrumb('index.php', Lang::trans('globalsystemname'));
$ca->addToBreadCrumb($registerdomain_page, $whmcs->get_lang('registerdomaintitle'));
...
$ca->setTemplate($registerdomain_tpl);
