...
$ca->setPageTitle($whmcs->get_lang('htmltemplatestitle'));

$ca->addToBreadCrumb('index.php', Lang::trans('globalsystemname'));
$ca->addToBreadCrumb($htmltemplates_page, $whmcs->get_lang('htmltemplatestitle'));
...
$ca->setTemplate($htmltemplates_tpl);
