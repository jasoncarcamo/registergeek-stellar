...
$ca->setPageTitle($whmcs->get_lang('transferdomaintitle'));

$ca->addToBreadCrumb('index.php', Lang::trans('globalsystemname'));
$ca->addToBreadCrumb($transferdomain_page, $whmcs->get_lang('transferdomaintitle'));
...
$ca->setTemplate($transferdomain_tpl);
