...
$ca->setPageTitle($whmcs->get_lang('blestatemplatestitle'));

$ca->addToBreadCrumb('index.php', Lang::trans('globalsystemname'));
$ca->addToBreadCrumb($blestatemplates_page, $whmcs->get_lang('blestatemplatestitle'));
...
$ca->setTemplate($blestatemplates_tpl);
