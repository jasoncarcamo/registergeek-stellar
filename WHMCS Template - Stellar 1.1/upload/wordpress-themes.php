...
$ca->setPageTitle($whmcs->get_lang('wordpressthemestitle'));

$ca->addToBreadCrumb('index.php', Lang::trans('globalsystemname'));
$ca->addToBreadCrumb($wordpressthemes_page, $whmcs->get_lang('wordpressthemestitle'));
...
$ca->setTemplate($wordpressthemes_tpl);
