...
$ca->setPageTitle($whmcs->get_lang('whmcsservicestitle'));

$ca->addToBreadCrumb('index.php', Lang::trans('globalsystemname'));
$ca->addToBreadCrumb($whmcsservices_page, $whmcs->get_lang('whmcsservicestitle'));
...
$ca->setTemplate($whmcsservices_tpl);
