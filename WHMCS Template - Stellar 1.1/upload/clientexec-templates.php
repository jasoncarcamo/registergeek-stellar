...
$ca->setPageTitle($whmcs->get_lang('clientexectemplatestitle'));

$ca->addToBreadCrumb('index.php', Lang::trans('globalsystemname'));
$ca->addToBreadCrumb($clientexectemplates_page, $whmcs->get_lang('clientexectemplatestitle'));
...
$ca->setTemplate($clientexectemplates_tpl);
