...
$ca->setPageTitle($whmcs->get_lang('whmcstemplatestitle'));

$ca->addToBreadCrumb('index.php', Lang::trans('globalsystemname'));
$ca->addToBreadCrumb($whmcstemplates_page, $whmcs->get_lang('whmcstemplatestitle'));
...
$ca->setTemplate($whmcstemplates_tpl);
