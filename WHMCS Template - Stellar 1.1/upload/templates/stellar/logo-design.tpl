...
This file contains the content of the logo design page. This page is part of the Zomex affiliate integration allowing you to easily promote our templates & services, earning a commission for every sale generated. 
...
The content of this page is editable within the language files in order to support multiple languages (Search for "logo-design.tpl"):
...
<div class="integrationgrid">		
	...
	<div class="highlightbox boldbox">
		...
		<div class="leftside">
			<a href="https://www.zomex.com/clients/aff.php?aff={$addons_affidz}&page=logodesign" target="_blank"><img src="https://www.zomex.com/libs/images/layout/custom-logo-design.png" alt="custom logo design" class="img-respond" /></a>
		</div>
		...
		<div class="rightside">
			...
			<div class="centercontents buttons">
				<a href="https://www.zomex.com/clients/aff.php?aff={$addons_affidz}&page=logodesign" target="_blank" class="button1 color1">{$LANG.button_more}</a>
				<a href="https://www.zomex.com/clients/aff.php?aff={$addons_affidz}&page=logodesign-order" target="_blank" class="button1 color2">{$LANG.addons_logodesign_order}</a>
				<div class="clear">&nbsp;</div>
			</div>
		</div>		
