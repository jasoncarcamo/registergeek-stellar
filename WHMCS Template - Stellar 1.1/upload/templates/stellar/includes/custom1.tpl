...
*}
	...
	<div class="bigheader" id="plans">
		<h2>{$LANG.custom1_plans_title}</h2>
	</div>
...
{if $custom1_layout_plans gte '1'}
		...
		<div class="box wow zoomInLeft box1 wow animated bounceInLeft{if $c1hp1_highlight eq "on"} highlight{/if}"{if $c1hp1_productlink} onclick="location.href='{$c1hp1_productlink}';"{/if} data-wow-delay="0.2s">
			...
			{if $LANG.custom1_box1_desc}
				<div class="description">{$LANG.custom1_box1_desc}</div>
			{/if}
			...
			<ul>
				{if $LANG.custom1_box1_feat1}<li><span>{$LANG.custom1_box1_feat1}</span></li>{/if}
				{if $LANG.custom1_box1_feat2}<li><span>{$LANG.custom1_box1_feat2}</span></li>{/if}
				{if $LANG.custom1_box1_feat3}<li><span>{$LANG.custom1_box1_feat3}</span></li>{/if}
...
{if $custom1_layout_plans gte '2'}
		...
		<div class="box wow zoomInLeft box2 wow animated bounceInLeft{if $c1hp2_highlight eq "on"} highlight{/if}"{if $c1hp2_productlink} onclick="location.href='{$c1hp2_productlink}';"{/if} data-wow-delay="0.4s">
			<div class="popular"></div>
			
			{if $LANG.custom1_box2_title}
			<div class="title">
				<h2 class="server1">{$LANG.custom1_box2_title}</h2>
			</div>
			{/if}	
			...
			{if $LANG.custom1_box2_desc}
				<div class="description">{$LANG.custom1_box2_desc}</div>
			{/if}
			...
			<ul>
				{if $LANG.custom1_box2_feat1}<li><span>{$LANG.custom1_box2_feat1}</span></li>{/if}
				{if $LANG.custom1_box2_feat2}<li><span>{$LANG.custom1_box2_feat2}</span></li>{/if}
				{if $LANG.custom1_box2_feat3}<li><span>{$LANG.custom1_box2_feat3}</span></li>{/if}
...
{if $custom1_layout_plans gte '3'}
		...
		<div class="box wow zoomInLeft box3 wow animated bounceInLeft{if $c1hp3_highlight eq "on"} highlight{/if}"{if $c1hp3_productlink} onclick="location.href='{$c1hp3_productlink}';"{/if} data-wow-delay="0.6s">
			<div class="popular"></div>
			
			{if $LANG.custom1_box3_title}
			<div class="title">
				<h2 class="server1">{$LANG.custom1_box3_title}</h2>
			</div>
			{/if}	
			...
			{if $LANG.custom1_box3_desc}
				<div class="description">{$LANG.custom1_box3_desc}</div>
			{/if}
			...
			<ul>
				{if $LANG.custom1_box3_feat1}<li><span>{$LANG.custom1_box3_feat1}</span></li>{/if}
				{if $LANG.custom1_box3_feat2}<li><span>{$LANG.custom1_box3_feat2}</span></li>{/if}
				{if $LANG.custom1_box3_feat3}<li><span>{$LANG.custom1_box3_feat3}</span></li>{/if}
...
{if $custom1_layout_plans gte '4'}
		...
		<div class="box wow zoomInLeft box4 wow animated bounceInLeft{if $c1hp4_highlight eq "on"} highlight{/if}"{if $c1hp4_productlink} onclick="location.href='{$c1hp4_productlink}';"{/if} data-wow-delay="0.8s">
			<div class="popular"></div>
			...
			{if $LANG.custom1_box4_desc}
				<div class="description">{$LANG.custom1_box4_desc}</div>
			{/if}
			...
			<ul>
				{if $LANG.custom1_box4_feat1}<li><span>{$LANG.custom1_box4_feat1}</span></li>{/if}
				{if $LANG.custom1_box4_feat2}<li><span>{$LANG.custom1_box4_feat2}</span></li>{/if}
				{if $LANG.custom1_box4_feat3}<li><span>{$LANG.custom1_box4_feat3}</span></li>{/if}
...
{if $custom1_layout_plans gte '5'}
		...
		<div class="box wow zoomInLeft box5 wow animated bounceInLeft{if $c1hp5_highlight eq "on"} highlight{/if}"{if $c1hp5_productlink} onclick="location.href='{$c1hp5_productlink}';"{/if} data-wow-delay="1.0s">
			<div class="popular"></div>
			
			{if $LANG.custom1_box5_title}
			<div class="title">
				<h2 class="server1">{$LANG.custom1_box5_title}</h2>
			</div>
			{/if}	
			...
			{if $LANG.custom1_box5_desc}
				<div class="description">{$LANG.custom1_box5_desc}</div>
			{/if}
			...
			<ul>
				{if $LANG.custom1_box5_feat1}<li><span>{$LANG.custom1_box5_feat1}</span></li>{/if}
				{if $LANG.custom1_box5_feat2}<li><span>{$LANG.custom1_box5_feat2}</span></li>{/if}
				{if $LANG.custom1_box5_feat3}<li><span>{$LANG.custom1_box5_feat3}</span></li>{/if}
...
{if $custom1_layout_plans gte '6'}
		...
		<div class="box wow zoomInLeft box6 wow animated bounceInLeft{if $c1hp6_highlight eq "on"} highlight{/if}"{if $c1hp6_productlink} onclick="location.href='{$c1hp6_productlink}';"{/if} data-wow-delay="1.2s">
			<div class="popular"></div>
			
			{if $LANG.custom1_box6_title}
			<div class="title">
				<h2 class="server1">{$LANG.custom1_box6_title}</h2>
			</div>
			{/if}	
			...
			{if $LANG.custom1_box6_desc}
				<div class="description">{$LANG.custom1_box6_desc}</div>
			{/if}
			...
			<ul>
				{if $LANG.custom1_box6_feat1}<li><span>{$LANG.custom1_box6_feat1}</span></li>{/if}
				{if $LANG.custom1_box6_feat2}<li><span>{$LANG.custom1_box6_feat2}</span></li>{/if}
				{if $LANG.custom1_box6_feat3}<li><span>{$LANG.custom1_box6_feat3}</span></li>{/if}
...
{if $custom1_layout_plans gte '7'}

		<div class="box wow zoomInLeft box7 wow animated bounceInLeft{if $c1hp7_highlight eq "on"} highlight{/if}"{if $c1hp7_productlink} onclick="location.href='{$c1hp7_productlink}';"{/if} data-wow-delay="1.4s">
			<div class="popular"></div>
			
			{if $LANG.custom1_box7_title}
			<div class="title">
				<h2 class="server1">{$LANG.custom1_box7_title}</h2>
			</div>
			{/if}	
			
			<div class="inner">
			
			{if $c1hp7_bprice or $LANG.custom1_box7_term}
				<div class="pricing">
					{if $c1hp7_bprice}<em>{$currency_prefix}</em>{$c1hp7_bprice}{/if}{if $LANG.custom1_box7_term}<span>/{$LANG.custom1_box7_term}</span>{/if}
				</div>	
			{/if}				
			
			{if $LANG.custom1_box7_desc}
				<div class="description">{$LANG.custom1_box7_desc}</div>
			{/if}
			
			{if $LANG.custom1_box7_feat1 or $LANG.custom1_box7_feat2 or $LANG.custom1_box7_feat3 or $LANG.custom1_box7_feat4 or $LANG.custom1_box7_feat5}
			<ul>
				{if $LANG.custom1_box7_feat1}<li><span>{$LANG.custom1_box7_feat1}</span></li>{/if}
				{if $LANG.custom1_box7_feat2}<li><span>{$LANG.custom1_box7_feat2}</span></li>{/if}
				{if $LANG.custom1_box7_feat3}<li><span>{$LANG.custom1_box7_feat3}</span></li>{/if}
				{if $LANG.custom1_box7_feat4}<li>{$LANG.custom1_box7_feat4}</li>{/if}
				{if $LANG.custom1_box7_feat5}<li>{$LANG.custom1_box7_feat5}</li>{/if}
			</ul>
			{/if}				
			
			{if $c1hp7_productlink}
			<div class="buttons">
				{if $c1hp7_productlink}<a href="{$c1hp7_productlink}" class="button1 color2">{$LANG.button_order}</a>{/if}
			</div>
			{/if}
...
{if $custom1_layout_plans gte '8'}

		<div class="box wow zoomInLeft box8 wow animated bounceInLeft{if $c1hp8_highlight eq "on"} highlight{/if}"{if $c1hp8_productlink} onclick="location.href='{$c1hp8_productlink}';"{/if} data-wow-delay="1.6s">
			<div class="popular"></div>
			
			{if $LANG.custom1_box8_title}
			<div class="title">
				<h2 class="server1">{$LANG.custom1_box8_title}</h2>
			</div>
			{/if}	
			
			<div class="inner">
			
			{if $c1hp8_bprice or $LANG.custom1_box8_term}
				<div class="pricing">
					{if $c1hp8_bprice}<em>{$currency_prefix}</em>{$c1hp8_bprice}{/if}{if $LANG.custom1_box8_term}<span>/{$LANG.custom1_box8_term}</span>{/if}
				</div>	
			{/if}				
			
			{if $LANG.custom1_box8_desc}
				<div class="description">{$LANG.custom1_box8_desc}</div>
			{/if}
			
			{if $LANG.custom1_box8_feat1 or $LANG.custom1_box8_feat2 or $LANG.custom1_box8_feat3 or $LANG.custom1_box8_feat4 or $LANG.custom1_box8_feat5}
			<ul>
				{if $LANG.custom1_box8_feat1}<li><span>{$LANG.custom1_box8_feat1}</span></li>{/if}
				{if $LANG.custom1_box8_feat2}<li><span>{$LANG.custom1_box8_feat2}</span></li>{/if}
				{if $LANG.custom1_box8_feat3}<li><span>{$LANG.custom1_box8_feat3}</span></li>{/if}
				{if $LANG.custom1_box8_feat4}<li>{$LANG.custom1_box8_feat4}</li>{/if}
				{if $LANG.custom1_box8_feat5}<li>{$LANG.custom1_box8_feat5}</li>{/if}
			</ul>
			{/if}				
			
			{if $c1hp8_productlink}
			<div class="buttons">
				{if $c1hp8_productlink}<a href="{$c1hp8_productlink}" class="button1 color2">{$LANG.button_order}</a>{/if}
			</div>
			{/if}
...
{if $custom1_layout_plans gte '9'}

		<div class="box wow zoomInLeft box9 wow animated bounceInLeft{if $c1hp9_highlight eq "on"} highlight{/if}"{if $c1hp9_productlink} onclick="location.href='{$c1hp9_productlink}';"{/if} data-wow-delay="1.8s">
			<div class="popular"></div>
			
			{if $LANG.custom1_box9_title}
			<div class="title">
				<h2 class="server1">{$LANG.custom1_box9_title}</h2>
			</div>
			{/if}	
			
			<div class="inner">
			
			{if $c1hp9_bprice or $LANG.custom1_box9_term}
				<div class="pricing">
					{if $c1hp9_bprice}<em>{$currency_prefix}</em>{$c1hp9_bprice}{/if}{if $LANG.custom1_box9_term}<span>/{$LANG.custom1_box9_term}</span>{/if}
				</div>	
			{/if}				
			
			{if $LANG.custom1_box9_desc}
				<div class="description">{$LANG.custom1_box9_desc}</div>
			{/if}
			
			{if $LANG.custom1_box9_feat1 or $LANG.custom1_box9_feat2 or $LANG.custom1_box9_feat3 or $LANG.custom1_box9_feat4 or $LANG.custom1_box9_feat5}
			<ul>
				{if $LANG.custom1_box9_feat1}<li><span>{$LANG.custom1_box9_feat1}</span></li>{/if}
				{if $LANG.custom1_box9_feat2}<li><span>{$LANG.custom1_box9_feat2}</span></li>{/if}
				{if $LANG.custom1_box9_feat3}<li><span>{$LANG.custom1_box9_feat3}</span></li>{/if}
				{if $LANG.custom1_box9_feat4}<li>{$LANG.custom1_box9_feat4}</li>{/if}
				{if $LANG.custom1_box9_feat5}<li>{$LANG.custom1_box9_feat5}</li>{/if}
			</ul>
			{/if}				
			
			{if $c1hp9_productlink}
			<div class="buttons">
				{if $c1hp9_productlink}<a href="{$c1hp9_productlink}" class="button1 color2">{$LANG.button_order}</a>{/if}
			</div>
			{/if}
...
{if $custom1_layout_plans gte '10'}

		<div class="box wow zoomInLeft box10 wow animated bounceInLeft{if $c1hp10_highlight eq "on"} highlight{/if}"{if $c1hp10_productlink} onclick="location.href='{$c1hp10_productlink}';"{/if} data-wow-delay="2.0s">
			<div class="popular"></div>
			
			{if $LANG.custom1_box10_title}
			<div class="title">
				<h2 class="server1">{$LANG.custom1_box10_title}</h2>
			</div>
			{/if}	
			
			<div class="inner">
			
			{if $c1hp10_bprice or $LANG.custom1_box10_term}
				<div class="pricing">
					{if $c1hp10_bprice}<em>{$currency_prefix}</em>{$c1hp10_bprice}{/if}{if $LANG.custom1_box10_term}<span>/{$LANG.custom1_box10_term}</span>{/if}
				</div>	
			{/if}				
			
			{if $LANG.custom1_box10_desc}
				<div class="description">{$LANG.custom1_box10_desc}</div>
			{/if}
			
			{if $LANG.custom1_box10_feat1 or $LANG.custom1_box10_feat2 or $LANG.custom1_box10_feat3 or $LANG.custom1_box10_feat4 or $LANG.custom1_box10_feat5}
			<ul>
				{if $LANG.custom1_box10_feat1}<li><span>{$LANG.custom1_box10_feat1}</span></li>{/if}
				{if $LANG.custom1_box10_feat2}<li><span>{$LANG.custom1_box10_feat2}</span></li>{/if}
				{if $LANG.custom1_box10_feat3}<li><span>{$LANG.custom1_box10_feat3}</span></li>{/if}
				{if $LANG.custom1_box10_feat4}<li>{$LANG.custom1_box10_feat4}</li>{/if}
				{if $LANG.custom1_box10_feat5}<li>{$LANG.custom1_box10_feat5}</li>{/if}
			</ul>
			{/if}				
			
			{if $c1hp10_productlink}
			<div class="buttons">
				{if $c1hp10_productlink}<a href="{$c1hp10_productlink}" class="button1 color2">{$LANG.button_order}</a>{/if}
			</div>
			{/if}
...
{elseif $custom1_layout_type eq 'table2'}

	<div class="table-responsive">
		<table>
			
			<tr>
				<th width="20%">{$LANG.custom1_table2_title0}</th>
				{if $LANG.custom1_table2_title1}<th>{$LANG.custom1_table2_title1}</th>{/if}
				{if $LANG.custom1_table2_title2}<th>{$LANG.custom1_table2_title2}</th>{/if}
				{if $LANG.custom1_table2_title3}<th>{$LANG.custom1_table2_title3}</th>{/if}
				{if $LANG.custom1_table2_title4}<th>{$LANG.custom1_table2_title4}</th>{/if}
				{if $LANG.custom1_table2_title5}<th>{$LANG.custom1_table2_title5}</th>{/if}
				{if $LANG.custom1_table2_title6}<th>{$LANG.custom1_table2_title6}</th>{/if}
				<th width="20%">&nbsp;</th>
			</tr>
			
			{if $custom1_layout_plans gte '1'}
			
			<tr class="tableplan odd wow zoomInLeft" onclick="location.href='{$c1hp1_productlink}';" data-wow-delay="0.2s">
				<td class="tabletitle{if $c1hp1_highlight eq "on"} highlight{/if}"><div class="popular"></div>{$LANG.custom1_box1_title}{if $LANG.custom1_box1_desc}<span class="tabledescription">{$LANG.custom1_box1_desc}</span>{/if}</td>
				{if $LANG.custom1_table2_title1}<td>{$LANG.custom1_table2_box1_feat1}</td>{/if}
				{if $LANG.custom1_table2_title2}<td>{$LANG.custom1_table2_box1_feat2}</td>{/if}
				{if $LANG.custom1_table2_title3}<td>{$LANG.custom1_table2_box1_feat3}</td>{/if}
				{if $LANG.custom1_table2_title4}<td>{$LANG.custom1_table2_box1_feat4}</td>{/if}
				{if $LANG.custom1_table2_title5}<td>{$LANG.custom1_table2_box1_feat5}</td>{/if}
				{if $LANG.custom1_table2_title6}<td>{$LANG.custom1_table2_box1_feat6}</td>{/if}
				<td><a href="{$c1hp1_productlink}" class="button1 color2">{$LANG.button_order}</a></td>
			</tr>	
			...
			<tr class="tableplan even wow zoomInLeft" onclick="location.href='{$c1hp2_productlink}';" data-wow-delay="0.4s">
				<td class="tabletitle{if $c1hp2_highlight eq "on"} highlight{/if}"><div class="popular"></div>{$LANG.custom1_box2_title}{if $LANG.custom1_box2_desc}<span class="tabledescription">{$LANG.custom1_box2_desc}</span>{/if}</td>
				{if $LANG.custom1_table2_title1}<td>{$LANG.custom1_table2_box2_feat1}</td>{/if}
				{if $LANG.custom1_table2_title2}<td>{$LANG.custom1_table2_box2_feat2}</td>{/if}
				{if $LANG.custom1_table2_title3}<td>{$LANG.custom1_table2_box2_feat3}</td>{/if}
				{if $LANG.custom1_table2_title4}<td>{$LANG.custom1_table2_box2_feat4}</td>{/if}
				{if $LANG.custom1_table2_title5}<td>{$LANG.custom1_table2_box2_feat5}</td>{/if}
				{if $LANG.custom1_table2_title6}<td>{$LANG.custom1_table2_box2_feat6}</td>{/if}
				<td><a href="{$c1hp2_productlink}" class="button1 color2">{$LANG.button_order}</a></td>
			</tr>	
			...
			<tr class="tableplan odd wow zoomInLeft" onclick="location.href='{$c1hp3_productlink}';" data-wow-delay="0.6s">
				<td class="tabletitle{if $c1hp3_highlight eq "on"} highlight{/if}"><div class="popular"></div>{$LANG.custom1_box3_title}{if $LANG.custom1_box3_desc}<span class="tabledescription">{$LANG.custom1_box3_desc}</span>{/if}</td>
				{if $LANG.custom1_table2_title1}<td>{$LANG.custom1_table2_box3_feat1}</td>{/if}
				{if $LANG.custom1_table2_title2}<td>{$LANG.custom1_table2_box3_feat2}</td>{/if}
				{if $LANG.custom1_table2_title3}<td>{$LANG.custom1_table2_box3_feat3}</td>{/if}
				{if $LANG.custom1_table2_title4}<td>{$LANG.custom1_table2_box3_feat4}</td>{/if}
				{if $LANG.custom1_table2_title5}<td>{$LANG.custom1_table2_box3_feat5}</td>{/if}
				{if $LANG.custom1_table2_title6}<td>{$LANG.custom1_table2_box3_feat6}</td>{/if}
				<td><a href="{$c1hp3_productlink}" class="button1 color2">{$LANG.button_order}</a></td>
			</tr>	
			...
			<tr class="tableplan even wow zoomInLeft" onclick="location.href='{$c1hp4_productlink}';" data-wow-delay="0.8s">
				<td class="tabletitle{if $c1hp4_highlight eq "on"} highlight{/if}"><div class="popular"></div>{$LANG.custom1_box4_title}{if $LANG.custom1_box4_desc}<span class="tabledescription">{$LANG.custom1_box4_desc}</span>{/if}</td>
				{if $LANG.custom1_table2_title1}<td>{$LANG.custom1_table2_box4_feat1}</td>{/if}
				{if $LANG.custom1_table2_title2}<td>{$LANG.custom1_table2_box4_feat2}</td>{/if}
				{if $LANG.custom1_table2_title3}<td>{$LANG.custom1_table2_box4_feat3}</td>{/if}
				{if $LANG.custom1_table2_title4}<td>{$LANG.custom1_table2_box4_feat4}</td>{/if}
				{if $LANG.custom1_table2_title5}<td>{$LANG.custom1_table2_box4_feat5}</td>{/if}
				{if $LANG.custom1_table2_title6}<td>{$LANG.custom1_table2_box4_feat6}</td>{/if}
				<td><a href="{$c1hp4_productlink}" class="button1 color2">{$LANG.button_order}</a></td>
			</tr>	
			...
			<tr class="tableplan odd wow zoomInLeft" onclick="location.href='{$c1hp5_productlink}';" data-wow-delay="1.0s">
				<td class="tabletitle{if $c1hp5_highlight eq "on"} highlight{/if}"><div class="popular"></div>{$LANG.custom1_box5_title}{if $LANG.custom1_box5_desc}<span class="tabledescription">{$LANG.custom1_box5_desc}</span>{/if}</td>
				{if $LANG.custom1_table2_title1}<td>{$LANG.custom1_table2_box5_feat1}</td>{/if}
				{if $LANG.custom1_table2_title2}<td>{$LANG.custom1_table2_box5_feat2}</td>{/if}
				{if $LANG.custom1_table2_title3}<td>{$LANG.custom1_table2_box5_feat3}</td>{/if}
				{if $LANG.custom1_table2_title4}<td>{$LANG.custom1_table2_box5_feat4}</td>{/if}
				{if $LANG.custom1_table2_title5}<td>{$LANG.custom1_table2_box5_feat5}</td>{/if}
				{if $LANG.custom1_table2_title6}<td>{$LANG.custom1_table2_box5_feat6}</td>{/if}
				<td><a href="{$c1hp5_productlink}" class="button1 color2">{$LANG.button_order}</a></td>
			</tr>	
			...
			<tr class="tableplan even wow zoomInLeft" onclick="location.href='{$c1hp6_productlink}';" data-wow-delay="1.2s">
				<td class="tabletitle{if $c1hp6_highlight eq "on"} highlight{/if}"><div class="popular"></div>{$LANG.custom1_box6_title}{if $LANG.custom1_box6_desc}<span class="tabledescription">{$LANG.custom1_box6_desc}</span>{/if}</td>
				{if $LANG.custom1_table2_title1}<td>{$LANG.custom1_table2_box6_feat1}</td>{/if}
				{if $LANG.custom1_table2_title2}<td>{$LANG.custom1_table2_box6_feat2}</td>{/if}
				{if $LANG.custom1_table2_title3}<td>{$LANG.custom1_table2_box6_feat3}</td>{/if}
				{if $LANG.custom1_table2_title4}<td>{$LANG.custom1_table2_box6_feat4}</td>{/if}
				{if $LANG.custom1_table2_title5}<td>{$LANG.custom1_table2_box6_feat5}</td>{/if}
				{if $LANG.custom1_table2_title6}<td>{$LANG.custom1_table2_box6_feat6}</td>{/if}
				<td><a href="{$c1hp6_productlink}" class="button1 color2">{$LANG.button_order}</a></td>
			</tr>	
			...
			<tr class="tableplan odd wow zoomInLeft" onclick="location.href='{$c1hp7_productlink}';" data-wow-delay="1.4s">
				<td class="tabletitle{if $c1hp7_highlight eq "on"} highlight{/if}"><div class="popular"></div>{$LANG.custom1_box7_title}{if $LANG.custom1_box7_desc}<span class="tabledescription">{$LANG.custom1_box7_desc}</span>{/if}</td>
				{if $LANG.custom1_table2_title1}<td>{$LANG.custom1_table2_box7_feat1}</td>{/if}
				{if $LANG.custom1_table2_title2}<td>{$LANG.custom1_table2_box7_feat2}</td>{/if}
				{if $LANG.custom1_table2_title3}<td>{$LANG.custom1_table2_box7_feat3}</td>{/if}
				{if $LANG.custom1_table2_title4}<td>{$LANG.custom1_table2_box7_feat4}</td>{/if}
				{if $LANG.custom1_table2_title5}<td>{$LANG.custom1_table2_box7_feat5}</td>{/if}
				{if $LANG.custom1_table2_title6}<td>{$LANG.custom1_table2_box7_feat6}</td>{/if}
				<td><a href="{$c1hp7_productlink}" class="button1 color2">{$LANG.button_order}</a></td>
			</tr>	
			...
			<tr class="tableplan even wow zoomInLeft" onclick="location.href='{$c1hp8_productlink}';" data-wow-delay="1.6s">
				<td class="tabletitle{if $c1hp8_highlight eq "on"} highlight{/if}"><div class="popular"></div>{$LANG.custom1_box8_title}{if $LANG.custom1_box8_desc}<span class="tabledescription">{$LANG.custom1_box8_desc}</span>{/if}</td>
				{if $LANG.custom1_table2_title1}<td>{$LANG.custom1_table2_box8_feat1}</td>{/if}
				{if $LANG.custom1_table2_title2}<td>{$LANG.custom1_table2_box8_feat2}</td>{/if}
				{if $LANG.custom1_table2_title3}<td>{$LANG.custom1_table2_box8_feat3}</td>{/if}
				{if $LANG.custom1_table2_title4}<td>{$LANG.custom1_table2_box8_feat4}</td>{/if}
				{if $LANG.custom1_table2_title5}<td>{$LANG.custom1_table2_box8_feat5}</td>{/if}
				{if $LANG.custom1_table2_title6}<td>{$LANG.custom1_table2_box8_feat6}</td>{/if}
				<td><a href="{$c1hp8_productlink}" class="button1 color2">{$LANG.button_order}</a></td>
			</tr>	
			...
			<tr class="tableplan odd wow zoomInLeft" onclick="location.href='{$c1hp9_productlink}';" data-wow-delay="1.8s">
				<td class="tabletitle{if $c1hp9_highlight eq "on"} highlight{/if}"><div class="popular"></div>{$LANG.custom1_box9_title}{if $LANG.custom1_box9_desc}<span class="tabledescription">{$LANG.custom1_box9_desc}</span>{/if}</td>
				{if $LANG.custom1_table2_title1}<td>{$LANG.custom1_table2_box9_feat1}</td>{/if}
				{if $LANG.custom1_table2_title2}<td>{$LANG.custom1_table2_box9_feat2}</td>{/if}
				{if $LANG.custom1_table2_title3}<td>{$LANG.custom1_table2_box9_feat3}</td>{/if}
				{if $LANG.custom1_table2_title4}<td>{$LANG.custom1_table2_box9_feat4}</td>{/if}
				{if $LANG.custom1_table2_title5}<td>{$LANG.custom1_table2_box9_feat5}</td>{/if}
				{if $LANG.custom1_table2_title6}<td>{$LANG.custom1_table2_box9_feat6}</td>{/if}
				<td><a href="{$c1hp9_productlink}" class="button1 color2">{$LANG.button_order}</a></td>
			</tr>	
			...
			<tr class="tableplan even wow zoomInLeft" onclick="location.href='{$c1hp10_productlink}';" data-wow-delay="2.0s">
				<td class="tabletitle{if $c1hp10_highlight eq "on"} highlight{/if}"><div class="popular"></div>{$LANG.custom1_box10_title}{if $LANG.custom1_box10_desc}<span class="tabledescription">{$LANG.custom1_box10_desc}</span>{/if}</td>
				{if $LANG.custom1_table2_title1}<td>{$LANG.custom1_table2_box10_feat1}</td>{/if}
				{if $LANG.custom1_table2_title2}<td>{$LANG.custom1_table2_box10_feat2}</td>{/if}
				{if $LANG.custom1_table2_title3}<td>{$LANG.custom1_table2_box10_feat3}</td>{/if}
				{if $LANG.custom1_table2_title4}<td>{$LANG.custom1_table2_box10_feat4}</td>{/if}
				{if $LANG.custom1_table2_title5}<td>{$LANG.custom1_table2_box10_feat5}</td>{/if}
				{if $LANG.custom1_table2_title6}<td>{$LANG.custom1_table2_box10_feat6}</td>{/if}
				<td><a href="{$c1hp10_productlink}" class="button1 color2">{$LANG.button_order}</a></td>
			</tr>	
...
{else}
			...
			<div class="pricingtable pricingtable{if $custom1_layout_plans eq '1'}1{elseif $custom1_layout_plans eq '2'}2{elseif $custom1_layout_plans eq '3'}3{elseif $custom1_layout_plans eq '4'}4{elseif $custom1_layout_plans eq '5'}5{elseif $custom1_layout_plans eq '6'}6{elseif $custom1_layout_plans eq '7'}6{elseif $custom1_layout_plans eq '8'}6{elseif $custom1_layout_plans eq '9'}6{elseif $custom1_layout_plans eq '10'}6{/if}">
				...
				{if $custom1_layout_plans gte '1'}							
					...
					<div class="block block1 wow zoomInLeft{if $c1hp1_highlight eq "on"} highlight{/if}"{if $c1hp1_productlink} onclick="location.href='{$c1hp1_productlink}';"{/if} data-wow-delay="0.2s">
						<div class="popular"></div>
				...
				{if $custom1_layout_plans gte '2'}							
					...
					<div class="block block2 wow zoomInLeft{if $c1hp2_highlight eq "on"} highlight{/if}"{if $c1hp2_productlink} onclick="location.href='{$c1hp2_productlink}';"{/if} data-wow-delay="0.4s">
						<div class="popular"></div>
				...
				{if $custom1_layout_plans gte '3'}							
					...
					<div class="block block3 wow zoomInLeft{if $c1hp3_highlight eq "on"} highlight{/if}"{if $c1hp3_productlink} onclick="location.href='{$c1hp3_productlink}';"{/if} data-wow-delay="0.6s">
						<div class="popular"></div>
				...
				{if $custom1_layout_plans gte '4'}							
					...
					<div class="block block4 wow zoomInLeft{if $c1hp4_highlight eq "on"} highlight{/if}"{if $c1hp4_productlink} onclick="location.href='{$c1hp4_productlink}';"{/if} data-wow-delay="0.8s">
						<div class="popular"></div>
				...
				{if $custom1_layout_plans gte '5'}							
					...
					<div class="block block5 wow zoomInLeft{if $c1hp5_highlight eq "on"} highlight{/if}"{if $c1hp5_productlink} onclick="location.href='{$c1hp5_productlink}';"{/if} data-wow-delay="1.0s">
						<div class="popular"></div>
				...
				{if $custom1_layout_plans gte '6'}							
					...
					<div class="block block6 wow zoomInLeft{if $c1hp6_highlight eq "on"} highlight{/if}"{if $c1hp6_productlink} onclick="location.href='{$c1hp6_productlink}';"{/if} data-wow-delay="1.2s">
						<div class="popular"></div>
...
{if $custom1_layout_plans gte '1'}
		...
		<div class="box wow zoomInLeft box1 wow animated bounceInLeft{if $c1hp1_highlight eq "on"} highlight{/if}"{if $c1hp1_productlink} onclick="location.href='{$c1hp1_productlink}';"{/if} data-wow-delay="0.2s">
			...
			<ul>
				{if $c1hp1_bfeat1}<li><span>{$c1hp1_bfeat1}</span></li>{/if}
				{if $c1hp1_bfeat2}<li><span>{$c1hp1_bfeat2}</span></li>{/if}
				{if $c1hp1_bfeat3}<li><span>{$c1hp1_bfeat3}</span></li>{/if}
...
{if $custom1_layout_plans gte '2'}
		...
		<div class="box wow zoomInLeft box2 wow animated bounceInLeft{if $c1hp2_highlight eq "on"} highlight{/if}"{if $c1hp2_productlink} onclick="location.href='{$c1hp2_productlink}';"{/if} data-wow-delay="0.4s">
			...
			{if $c1hp2_name}
			<div class="title">
				<h2 class="server1">{$c1hp2_name}</h2>
			</div>
			{/if}	
			...
			<ul>
				{if $c1hp2_bfeat1}<li><span>{$c1hp2_bfeat1}</span></li>{/if}
				{if $c1hp2_bfeat2}<li><span>{$c1hp2_bfeat2}</span></li>{/if}
				{if $c1hp2_bfeat3}<li><span>{$c1hp2_bfeat3}</span></li>{/if}
...
{if $custom1_layout_plans gte '3'}
		...
		<div class="box wow zoomInLeft box3 wow animated bounceInLeft{if $c1hp3_highlight eq "on"} highlight{/if}"{if $c1hp3_productlink} onclick="location.href='{$c1hp3_productlink}';"{/if} data-wow-delay="0.6s">
			...
			{if $c1hp3_name}
			<div class="title">
				<h2 class="server1">{$c1hp3_name}</h2>
			</div>
			{/if}	
			...
			<ul>
				{if $c1hp3_bfeat1}<li><span>{$c1hp3_bfeat1}</span></li>{/if}
				{if $c1hp3_bfeat2}<li><span>{$c1hp3_bfeat2}</span></li>{/if}
				{if $c1hp3_bfeat3}<li><span>{$c1hp3_bfeat3}</span></li>{/if}
...
{if $custom1_layout_plans gte '4'}
		...
		<div class="box wow zoomInLeft box4 wow animated bounceInLeft{if $c1hp4_highlight eq "on"} highlight{/if}"{if $c1hp4_productlink} onclick="location.href='{$c1hp4_productlink}';"{/if} data-wow-delay="0.8s">
			...
			<ul>
				{if $c1hp4_bfeat1}<li><span>{$c1hp4_bfeat1}</span></li>{/if}
				{if $c1hp4_bfeat2}<li><span>{$c1hp4_bfeat2}</span></li>{/if}
				{if $c1hp4_bfeat3}<li><span>{$c1hp4_bfeat3}</span></li>{/if}
...
{if $custom1_layout_plans gte '5'}
		...
		<div class="box wow zoomInLeft box5 wow animated bounceInLeft{if $c1hp5_highlight eq "on"} highlight{/if}"{if $c1hp5_productlink} onclick="location.href='{$c1hp5_productlink}';"{/if} data-wow-delay="1.0s">
			...
			{if $c1hp5_name}
			<div class="title">
				<h2 class="server1">{$c1hp5_name}</h2>
			</div>
			{/if}	
			...
			<ul>
				{if $c1hp5_bfeat1}<li><span>{$c1hp5_bfeat1}</span></li>{/if}
				{if $c1hp5_bfeat2}<li><span>{$c1hp5_bfeat2}</span></li>{/if}
				{if $c1hp5_bfeat3}<li><span>{$c1hp5_bfeat3}</span></li>{/if}
...
{if $custom1_layout_plans gte '6'}
		...
		<div class="box wow zoomInLeft box6 wow animated bounceInLeft{if $c1hp6_highlight eq "on"} highlight{/if}"{if $c1hp6_productlink} onclick="location.href='{$c1hp6_productlink}';"{/if} data-wow-delay="1.2s">
			...
			{if $c1hp6_name}
			<div class="title">
				<h2 class="server1">{$c1hp6_name}</h2>
			</div>
			{/if}	
			...
			<ul>
				{if $c1hp6_bfeat1}<li><span>{$c1hp6_bfeat1}</span></li>{/if}
				{if $c1hp6_bfeat2}<li><span>{$c1hp6_bfeat2}</span></li>{/if}
				{if $c1hp6_bfeat3}<li><span>{$c1hp6_bfeat3}</span></li>{/if}
...
{if $custom1_layout_plans gte '7'}
		...
		<div class="box wow zoomInLeft box7 wow animated bounceInLeft{if $c1hp7_highlight eq "on"} highlight{/if}"{if $c1hp7_productlink} onclick="location.href='{$c1hp7_productlink}';"{/if} data-wow-delay="1.4s">
			...
			{if $c1hp7_name}
			<div class="title">
				<h2 class="server1">{$c1hp7_name}</h2>
			</div>
			{/if}	
			
			<div class="inner">
			
			{if $c1hp7_bprice or $c1hp7_bterm}
				<div class="pricing">
					{if $c1hp7_bprice}<em>{$currency_prefix}</em>{$c1hp7_bprice}{/if}{if $c1hp7_bterm}<span>/{$c1hp7_bterm}</span>{/if}
				</div>	
			{/if}												
			...
			{if $c1hp7_bfeat1 or $c1hp7_bfeat2 or $c1hp7_bfeat3 or $c1hp7_bfeat4 or $c1hp7_bfeat5}
			<ul>
				{if $c1hp7_bfeat1}<li><span>{$c1hp7_bfeat1}</span></li>{/if}
				{if $c1hp7_bfeat2}<li><span>{$c1hp7_bfeat2}</span></li>{/if}
				{if $c1hp7_bfeat3}<li><span>{$c1hp7_bfeat3}</span></li>{/if}
				{if $c1hp7_bfeat4}<li>{$c1hp7_bfeat4}</li>{/if}
				{if $c1hp7_bfeat5}<li>{$c1hp7_bfeat5}</li>{/if}
			</ul>
			{/if}			
...
{if $custom1_layout_plans gte '8'}
		...
		<div class="box wow zoomInLeft box8 wow animated bounceInLeft{if $c1hp8_highlight eq "on"} highlight{/if}"{if $c1hp8_productlink} onclick="location.href='{$c1hp8_productlink}';"{/if} data-wow-delay="1.6s">
			...
			{if $c1hp8_name}
			<div class="title">
				<h2 class="server1">{$c1hp8_name}</h2>
			</div>
			{/if}	
			
			<div class="inner">
			
			{if $c1hp8_bprice or $c1hp8_bterm}
				<div class="pricing">
					{if $c1hp8_bprice}<em>{$currency_prefix}</em>{$c1hp8_bprice}{/if}{if $c1hp8_bterm}<span>/{$c1hp8_bterm}</span>{/if}
				</div>	
			{/if}												
			...
			{if $c1hp8_bfeat1 or $c1hp8_bfeat2 or $c1hp8_bfeat3 or $c1hp8_bfeat4 or $c1hp8_bfeat5}
			<ul>
				{if $c1hp8_bfeat1}<li><span>{$c1hp8_bfeat1}</span></li>{/if}
				{if $c1hp8_bfeat2}<li><span>{$c1hp8_bfeat2}</span></li>{/if}
				{if $c1hp8_bfeat3}<li><span>{$c1hp8_bfeat3}</span></li>{/if}
				{if $c1hp8_bfeat4}<li>{$c1hp8_bfeat4}</li>{/if}
				{if $c1hp8_bfeat5}<li>{$c1hp8_bfeat5}</li>{/if}
			</ul>
			{/if}			
...
{if $custom1_layout_plans gte '9'}
		...
		<div class="box wow zoomInLeft box9 wow animated bounceInLeft{if $c1hp9_highlight eq "on"} highlight{/if}"{if $c1hp9_productlink} onclick="location.href='{$c1hp9_productlink}';"{/if} data-wow-delay="1.8s">
			...
			{if $c1hp9_name}
			<div class="title">
				<h2 class="server1">{$c1hp9_name}</h2>
			</div>
			{/if}	
			
			<div class="inner">
			
			{if $c1hp9_bprice or $c1hp9_bterm}
				<div class="pricing">
					{if $c1hp9_bprice}<em>{$currency_prefix}</em>{$c1hp9_bprice}{/if}{if $c1hp9_bterm}<span>/{$c1hp9_bterm}</span>{/if}
				</div>	
			{/if}												
			...
			{if $c1hp9_bfeat1 or $c1hp9_bfeat2 or $c1hp9_bfeat3 or $c1hp9_bfeat4 or $c1hp9_bfeat5}
			<ul>
				{if $c1hp9_bfeat1}<li><span>{$c1hp9_bfeat1}</span></li>{/if}
				{if $c1hp9_bfeat2}<li><span>{$c1hp9_bfeat2}</span></li>{/if}
				{if $c1hp9_bfeat3}<li><span>{$c1hp9_bfeat3}</span></li>{/if}
				{if $c1hp9_bfeat4}<li>{$c1hp9_bfeat4}</li>{/if}
				{if $c1hp9_bfeat5}<li>{$c1hp9_bfeat5}</li>{/if}
			</ul>
			{/if}			
...
{if $custom1_layout_plans gte '10'}
		...
		<div class="box wow zoomInLeft box10 wow animated bounceInLeft{if $c1hp10_highlight eq "on"} highlight{/if}"{if $c1hp10_productlink} onclick="location.href='{$c1hp10_productlink}';"{/if} data-wow-delay="2.0s">
			...
			{if $c1hp10_name}
			<div class="title">
				<h2 class="server1">{$c1hp10_name}</h2>
			</div>
			{/if}	
			
			<div class="inner">
			
			{if $c1hp10_bprice or $c1hp10_bterm}
				<div class="pricing">
					{if $c1hp10_bprice}<em>{$currency_prefix}</em>{$c1hp10_bprice}{/if}{if $c1hp10_bterm}<span>/{$c1hp10_bterm}</span>{/if}
				</div>	
			{/if}												
			...
			{if $c1hp10_bfeat1 or $c1hp10_bfeat2 or $c1hp10_bfeat3 or $c1hp10_bfeat4 or $c1hp10_bfeat5}
			<ul>
				{if $c1hp10_bfeat1}<li><span>{$c1hp10_bfeat1}</span></li>{/if}
				{if $c1hp10_bfeat2}<li><span>{$c1hp10_bfeat2}</span></li>{/if}
				{if $c1hp10_bfeat3}<li><span>{$c1hp10_bfeat3}</span></li>{/if}
				{if $c1hp10_bfeat4}<li>{$c1hp10_bfeat4}</li>{/if}
				{if $c1hp10_bfeat5}<li>{$c1hp10_bfeat5}</li>{/if}
			</ul>
			{/if}			
...
{elseif $custom1_layout_type eq 'table2'}
	...
	<div class="table-responsive">
		<table>
			...
			<tr>
				<th width="20%">{$LANG.custom1_table2_title0}</th>
				{if $c1hp_tfeat1}<th>{$c1hp_tfeat1}</th>{/if}
				{if $c1hp_tfeat2}<th>{$c1hp_tfeat2}</th>{/if}
				{if $c1hp_tfeat3}<th>{$c1hp_tfeat3}</th>{/if}
				{if $c1hp_tfeat4}<th>{$c1hp_tfeat4}</th>{/if}
				{if $c1hp_tfeat5}<th>{$c1hp_tfeat5}</th>{/if}
				{if $c1hp_tfeat6}<th>{$c1hp_tfeat6}</th>{/if}
				<th width="20%">&nbsp;</th>
			</tr>
			...
			<tr class="tableplan odd wow zoomInLeft" onclick="location.href='{$c1hp1_productlink}';" data-wow-delay="0.2s">
				<td class="tabletitle{if $c1hp1_highlight eq "on"} highlight{/if}"><div class="popular"></div>{$c1hp1_name}{if $c1hp1_desc}<span class="tabledescription">{$c1hp1_desc}</span>{/if}</td>
				{if $c1hp_tfeat1}<td>{$c1hp1_tfeat1}</td>{/if}
				{if $c1hp_tfeat2}<td>{$c1hp1_tfeat2}</td>{/if}
				{if $c1hp_tfeat3}<td>{$c1hp1_tfeat3}</td>{/if}
				{if $c1hp_tfeat4}<td>{$c1hp1_tfeat4}</td>{/if}
				{if $c1hp_tfeat5}<td>{$c1hp1_tfeat5}</td>{/if}
				{if $c1hp_tfeat6}<td>{$c1hp1_tfeat6}</td>{/if}
				<td><a href="{$c1hp1_productlink}" class="button1 color2">{$LANG.button_order}</a></td>
			</tr>	
			...
			<tr class="tableplan even wow zoomInLeft" onclick="location.href='{$c1hp2_productlink}';" data-wow-delay="0.4s">
				<td class="tabletitle{if $c1hp2_highlight eq "on"} highlight{/if}"><div class="popular"></div>{$c1hp2_name}{if $c1hp2_desc}<span class="tabledescription">{$c1hp2_desc}</span>{/if}</td>
				{if $c1hp_tfeat1}<td>{$c1hp2_tfeat1}</td>{/if}
				{if $c1hp_tfeat2}<td>{$c1hp2_tfeat2}</td>{/if}
				{if $c1hp_tfeat3}<td>{$c1hp2_tfeat3}</td>{/if}
				{if $c1hp_tfeat4}<td>{$c1hp2_tfeat4}</td>{/if}
				{if $c1hp_tfeat5}<td>{$c1hp2_tfeat5}</td>{/if}
				{if $c1hp_tfeat6}<td>{$c1hp2_tfeat6}</td>{/if}
				<td><a href="{$c1hp2_productlink}" class="button1 color2">{$LANG.button_order}</a></td>
			</tr>
			...
			<tr class="tableplan odd wow zoomInLeft" onclick="location.href='{$c1hp3_productlink}';" data-wow-delay="0.6s">
				<td class="tabletitle{if $c1hp3_highlight eq "on"} highlight{/if}"><div class="popular"></div>{$c1hp3_name}{if $c1hp3_desc}<span class="tabledescription">{$c1hp3_desc}</span>{/if}</td>
				{if $c1hp_tfeat1}<td>{$c1hp3_tfeat1}</td>{/if}
				{if $c1hp_tfeat2}<td>{$c1hp3_tfeat2}</td>{/if}
				{if $c1hp_tfeat3}<td>{$c1hp3_tfeat3}</td>{/if}
				{if $c1hp_tfeat4}<td>{$c1hp3_tfeat4}</td>{/if}
				{if $c1hp_tfeat5}<td>{$c1hp3_tfeat5}</td>{/if}
				{if $c1hp_tfeat6}<td>{$c1hp3_tfeat6}</td>{/if}
				<td><a href="{$c1hp3_productlink}" class="button1 color2">{$LANG.button_order}</a></td>
			</tr>
			...
			<tr class="tableplan even wow zoomInLeft" onclick="location.href='{$c1hp4_productlink}';" data-wow-delay="0.8s">
				<td class="tabletitle{if $c1hp4_highlight eq "on"} highlight{/if}"><div class="popular"></div>{$c1hp4_name}{if $c1hp4_desc}<span class="tabledescription">{$c1hp4_desc}</span>{/if}</td>
				{if $c1hp_tfeat1}<td>{$c1hp4_tfeat1}</td>{/if}
				{if $c1hp_tfeat2}<td>{$c1hp4_tfeat2}</td>{/if}
				{if $c1hp_tfeat3}<td>{$c1hp4_tfeat3}</td>{/if}
				{if $c1hp_tfeat4}<td>{$c1hp4_tfeat4}</td>{/if}
				{if $c1hp_tfeat5}<td>{$c1hp4_tfeat5}</td>{/if}
				{if $c1hp_tfeat6}<td>{$c1hp4_tfeat6}</td>{/if}
				<td><a href="{$c1hp4_productlink}" class="button1 color2">{$LANG.button_order}</a></td>
			</tr>
			...
			<tr class="tableplan odd wow zoomInLeft" onclick="location.href='{$c1hp5_productlink}';" data-wow-delay="1.0s">
				<td class="tabletitle{if $c1hp5_highlight eq "on"} highlight{/if}"><div class="popular"></div>{$c1hp5_name}{if $c1hp5_desc}<span class="tabledescription">{$c1hp5_desc}</span>{/if}</td>
				{if $c1hp_tfeat1}<td>{$c1hp5_tfeat1}</td>{/if}
				{if $c1hp_tfeat2}<td>{$c1hp5_tfeat2}</td>{/if}
				{if $c1hp_tfeat3}<td>{$c1hp5_tfeat3}</td>{/if}
				{if $c1hp_tfeat4}<td>{$c1hp5_tfeat4}</td>{/if}
				{if $c1hp_tfeat5}<td>{$c1hp5_tfeat5}</td>{/if}
				{if $c1hp_tfeat6}<td>{$c1hp5_tfeat6}</td>{/if}
				<td><a href="{$c1hp5_productlink}" class="button1 color2">{$LANG.button_order}</a></td>
			</tr>
			...
			<tr class="tableplan even wow zoomInLeft" onclick="location.href='{$c1hp6_productlink}';" data-wow-delay="1.2s">
				<td class="tabletitle{if $c1hp6_highlight eq "on"} highlight{/if}"><div class="popular"></div>{$c1hp6_name}{if $c1hp6_desc}<span class="tabledescription">{$c1hp6_desc}</span>{/if}</td>
				{if $c1hp_tfeat1}<td>{$c1hp6_tfeat1}</td>{/if}
				{if $c1hp_tfeat2}<td>{$c1hp6_tfeat2}</td>{/if}
				{if $c1hp_tfeat3}<td>{$c1hp6_tfeat3}</td>{/if}
				{if $c1hp_tfeat4}<td>{$c1hp6_tfeat4}</td>{/if}
				{if $c1hp_tfeat5}<td>{$c1hp6_tfeat5}</td>{/if}
				{if $c1hp_tfeat6}<td>{$c1hp6_tfeat6}</td>{/if}
				<td><a href="{$c1hp6_productlink}" class="button1 color2">{$LANG.button_order}</a></td>
			</tr>			
			...
			<tr class="tableplan odd wow zoomInLeft" onclick="location.href='{$c1hp7_productlink}';" data-wow-delay="1.4s">
				<td class="tabletitle{if $c1hp7_highlight eq "on"} highlight{/if}"><div class="popular"></div>{$c1hp7_name}{if $c1hp7_desc}<span class="tabledescription">{$c1hp7_desc}</span>{/if}</td>
				{if $c1hp_tfeat1}<td>{$c1hp7_tfeat1}</td>{/if}
				{if $c1hp_tfeat2}<td>{$c1hp7_tfeat2}</td>{/if}
				{if $c1hp_tfeat3}<td>{$c1hp7_tfeat3}</td>{/if}
				{if $c1hp_tfeat4}<td>{$c1hp7_tfeat4}</td>{/if}
				{if $c1hp_tfeat5}<td>{$c1hp7_tfeat5}</td>{/if}
				{if $c1hp_tfeat6}<td>{$c1hp7_tfeat6}</td>{/if}
				<td><a href="{$c1hp7_productlink}" class="button1 color2">{$LANG.button_order}</a></td>
			</tr>			
			...
			<tr class="tableplan even wow zoomInLeft" onclick="location.href='{$c1hp8_productlink}';" data-wow-delay="1.6s">
				<td class="tabletitle{if $c1hp8_highlight eq "on"} highlight{/if}"><div class="popular"></div>{$c1hp8_name}{if $c1hp8_desc}<span class="tabledescription">{$c1hp8_desc}</span>{/if}</td>
				{if $c1hp_tfeat1}<td>{$c1hp8_tfeat1}</td>{/if}
				{if $c1hp_tfeat2}<td>{$c1hp8_tfeat2}</td>{/if}
				{if $c1hp_tfeat3}<td>{$c1hp8_tfeat3}</td>{/if}
				{if $c1hp_tfeat4}<td>{$c1hp8_tfeat4}</td>{/if}
				{if $c1hp_tfeat5}<td>{$c1hp8_tfeat5}</td>{/if}
				{if $c1hp_tfeat6}<td>{$c1hp8_tfeat6}</td>{/if}
				<td><a href="{$c1hp8_productlink}" class="button1 color2">{$LANG.button_order}</a></td>
			</tr>			
			...
			<tr class="tableplan odd wow zoomInLeft" onclick="location.href='{$c1hp9_productlink}';" data-wow-delay="1.8s">
				<td class="tabletitle{if $c1hp9_highlight eq "on"} highlight{/if}"><div class="popular"></div>{$c1hp9_name}{if $c1hp9_desc}<span class="tabledescription">{$c1hp9_desc}</span>{/if}</td>
				{if $c1hp_tfeat1}<td>{$c1hp9_tfeat1}</td>{/if}
				{if $c1hp_tfeat2}<td>{$c1hp9_tfeat2}</td>{/if}
				{if $c1hp_tfeat3}<td>{$c1hp9_tfeat3}</td>{/if}
				{if $c1hp_tfeat4}<td>{$c1hp9_tfeat4}</td>{/if}
				{if $c1hp_tfeat5}<td>{$c1hp9_tfeat5}</td>{/if}
				{if $c1hp_tfeat6}<td>{$c1hp9_tfeat6}</td>{/if}
				<td><a href="{$c1hp9_productlink}" class="button1 color2">{$LANG.button_order}</a></td>
			</tr>			
			...
			<tr class="tableplan even wow zoomInLeft" onclick="location.href='{$c1hp10_productlink}';" data-wow-delay="2.0s">
				<td class="tabletitle{if $c1hp10_highlight eq "on"} highlight{/if}"><div class="popular"></div>{$c1hp10_name}{if $c1hp10_desc}<span class="tabledescription">{$c1hp10_desc}</span>{/if}</td>
				{if $c1hp_tfeat1}<td>{$c1hp10_tfeat1}</td>{/if}
				{if $c1hp_tfeat2}<td>{$c1hp10_tfeat2}</td>{/if}
				{if $c1hp_tfeat3}<td>{$c1hp10_tfeat3}</td>{/if}
				{if $c1hp_tfeat4}<td>{$c1hp10_tfeat4}</td>{/if}
				{if $c1hp_tfeat5}<td>{$c1hp10_tfeat5}</td>{/if}
				{if $c1hp_tfeat6}<td>{$c1hp10_tfeat6}</td>{/if}
				<td><a href="{$c1hp10_productlink}" class="button1 color2">{$LANG.button_order}</a></td>
			</tr>			
