...
This file contains the content of the wordpress services page. This page is part of the Zomex affiliate integration allowing you to easily promote our templates & services, earning a commission for every sale generated. 
...
The content of this page is editable within the language files in order to support multiple languages (Search for "wordpress-services.tpl"):
...
<div class="integrationgrid">	
	...
	<p>{$LANG.addons_wordpressservices_text}</p>	
	
	<div class="highlightbox product wow zoomInDown boldbox">
		
		<h2 class="centercontents">{$LANG.addons_wordpressservices_1_title}</h2>
		
		<p>{$LANG.addons_wordpressservices_1_desc}</p>
		
		<p class="centercontents"><strong>{$LANG.addons_price}</strong> {$LANG.addons_from} $150.00 {$LANG.addons_onetime}</p>
		
		<div class="centercontents buttons">
			<a href="https://www.zomex.com/clients/aff.php?aff={$addons_affidz}&page=wordpress" target="_blank" class="button1 color1">{$LANG.button_more}</a>
			<a href="https://www.zomex.com/clients/aff.php?aff={$addons_affidz}&page=wordpress-integration" target="_blank" class="button1 color2">{$LANG.addons_wordpressservices_1_order}</a>
			<div class="clear">&nbsp;</div>
		</div>
	...
	<div class="highlightbox product wow zoomInDown boldbox">
		...
		<h2 class="centercontents">{$LANG.addons_wordpressservices_2_title}</h2>
		
		<p>{$LANG.addons_wordpressservices_2_desc}</p>
		
		<p class="centercontents"><strong>{$LANG.addons_price}</strong> {$LANG.addons_from} $35.00 {$LANG.addons_onetime}</p>
		
		<div class="centercontents buttons">
			<a href="https://www.zomex.com/clients/aff.php?aff={$addons_affidz}&page=wordpress" target="_blank" class="button1 color1">{$LANG.button_more}</a>
			<a href="https://www.zomex.com/clients/aff.php?aff={$addons_affidz}&page=wordpress-configuration" target="_blank" class="button1 color2">{$LANG.addons_wordpressservices_2_order}</a>
			<div class="clear">&nbsp;</div>
		</div>
	...
	<div class="highlightbox product wow zoomInDown boldbox">
		...
		<h2 class="centercontents">{$LANG.addons_wordpressservices_3_title}</h2>
		
		<p>{$LANG.addons_wordpressservices_3_desc}</p>
		
		<p class="centercontents"><strong>{$LANG.addons_price}</strong> {$LANG.addons_from} $10.00 {$LANG.addons_onetime}</p>
		
		<div class="centercontents buttons">
			<a href="https://www.zomex.com/clients/aff.php?aff={$addons_affidz}&page=wordpress" target="_blank" class="button1 color1">{$LANG.button_more}</a>
			<a href="https://www.zomex.com/clients/aff.php?aff={$addons_affidz}&page=wordpress-install" target="_blank" class="button1 color2">{$LANG.addons_wordpressservices_3_order}</a>
			<div class="clear">&nbsp;</div>
		</div>
...
<iframe class="affiframe" width="100%" scrolling="no" frameborder="0" src="https://www.zomex.com/clients/aff.php?aff={$addons_affidz}&page=whitelabel-wordpressservices" onload="scrolltotop();"></iframe>
