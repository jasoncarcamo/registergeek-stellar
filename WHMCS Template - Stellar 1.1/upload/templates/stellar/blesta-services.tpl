...
This file contains the content of the blesta services page. This page is part of the Zomex affiliate integration allowing you to easily promote our templates & services, earning a commission for every sale generated. 
...
The content of this page is editable within the language files in order to support multiple languages (Search for "blesta-services.tpl"):
...
<div class="integrationgrid">	
	...
	<p>{$LANG.addons_blestaservices_text}</p>
	
	<div class="highlightbox product wow zoomInDown boldbox">
		
		<h2 class="centercontents">{$LANG.addons_blestaservices_1_title}</h2>
		
		<p>{$LANG.addons_blestaservices_1_desc}</p>
		...
		<div class="centercontents buttons">
			<a href="https://www.zomex.com/clients/aff.php?aff={$addons_affidz}&page=blesta" target="_blank" class="button1 color1">{$LANG.button_more}</a>
			<a href="https://www.zomex.com/clients/aff.php?aff={$addons_affidz}&page=blesta-integration" target="_blank" class="button1 color2">{$LANG.addons_blestaservices_1_order}</a>
			<div class="clear">&nbsp;</div>
		</div>
	...
	<div class="highlightbox product wow zoomInDown boldbox">
		...
		<h2 class="centercontents">{$LANG.addons_blestaservices_2_title}</h2>
		
		<p>{$LANG.addons_blestaservices_2_desc}</p>
		...
		<p class="centercontents buttons">
			<a href="https://www.zomex.com/clients/aff.php?aff={$addons_affidz}&page=blesta" target="_blank" class="button1 color1">{$LANG.button_more}</a>
			<a href="https://www.zomex.com/clients/aff.php?aff={$addons_affidz}&page=blesta-install" target="_blank" class="button1 color2">{$LANG.addons_blestaservices_2_order}</a>
			<div class="clear">&nbsp;</div>
		</p>
...
<iframe class="affiframe" width="100%" scrolling="no" frameborder="0" src="https://www.zomex.com/clients/aff.php?aff={$addons_affidz}&page=whitelabel-blestaservices" onload="scrolltotop();"></iframe>
