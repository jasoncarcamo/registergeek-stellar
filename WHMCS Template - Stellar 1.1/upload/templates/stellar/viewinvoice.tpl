...
<head>
    ...
    <script src="{$WEB_ROOT}/templates/{$template}/invoicequote/scripts.js?v={$versionHash}"></script>
        ...
        {else}
            ...
            <div class="row invoice-header">
                ...
                <div class="invoicecolumn invoice-header-left">
                    ...
                    <h4>{$LANG.invoicesdatecreated}: {$date}</h4>
                    
                    <h4>{$LANG.invoicesdatedue}: {if $status eq "Unpaid"}<span class="boldred">{/if}{$datedue}{if $status eq "Unpaid"}</span>{/if}</h4>
                ...
                <div class="invoicecolumn invoice-header-right">
                    ...
                    <span class="small-text" data-role="paymethod-info">
                        {if $status eq "Unpaid" && $allowchangegateway}
                            <form method="post" action="{$smarty.server.PHP_SELF}?id={$invoiceid}" class="form-inline paymentoptionselect">
                                {$gatewaydropdown}
                            </form>
                        {else}
            ...
            <div class="row addressrow">
                ...
                <div class="invoice-col addresscolumn addresscolumn-left">
                ...
                <div class="invoice-col addresscolumn addresscolumn-right">
                        ...
                        <table class="table table-condensed">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="total-row text-center{if $status eq "Paid"} boldgreen{elseif $status eq "Unpaid"} boldred{else}{/if}">{$total}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
