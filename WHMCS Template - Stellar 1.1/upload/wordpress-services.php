...
$ca->setPageTitle($whmcs->get_lang('wordpressservicestitle'));

$ca->addToBreadCrumb('index.php', Lang::trans('globalsystemname'));
$ca->addToBreadCrumb($wordpressservices_page, $whmcs->get_lang('wordpressservicestitle'));
...
$ca->setTemplate($wordpressservices_tpl);
