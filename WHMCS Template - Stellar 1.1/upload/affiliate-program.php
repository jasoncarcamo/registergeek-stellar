...
$ca->setPageTitle($whmcs->get_lang('affiliateprogramtitle'));

$ca->addToBreadCrumb('index.php', Lang::trans('globalsystemname'));
$ca->addToBreadCrumb($affiliateprogram_page, $whmcs->get_lang('affiliateprogramtitle'));
...
$ca->setTemplate($affiliateprogram_tpl);
