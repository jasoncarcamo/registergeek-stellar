...
$ca->setPageTitle($whmcs->get_lang('blestaservicestitle'));

$ca->addToBreadCrumb('index.php', Lang::trans('globalsystemname'));
$ca->addToBreadCrumb($blestaservices_page, $whmcs->get_lang('blestaservicestitle'));
...
$ca->setTemplate($blestaservices_tpl);
