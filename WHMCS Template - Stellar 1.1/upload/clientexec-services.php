...
$ca->setPageTitle($whmcs->get_lang('clientexecservicestitle'));

$ca->addToBreadCrumb('index.php', Lang::trans('globalsystemname'));
$ca->addToBreadCrumb($clientexecservices_page, $whmcs->get_lang('clientexecservicestitle'));
...
$ca->setTemplate($clientexecservices_tpl);
